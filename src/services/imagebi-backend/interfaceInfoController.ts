...
/** deleteBatchInterfaceInfo POST /api/interfaceInfo/deleteBatch */
export async function deleteBatchInterfaceInfoUsingPost(
  body: API.DeleteBatchRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseboolean>('/api/interfaceInfo/deleteBatch', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
