...
/** getUserInterfaceInfoByIds GET /api/userInterfaceInfo/getByIds */
export async function getUserInterfaceInfoByIdsUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getUserInterfaceInfoByIdsUsingGETParams,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseUserInterfaceInfo>('/api/userInterfaceInfo/getByIds', {
    method: 'GET',
    params: {
      ...params,
    },
